...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="{{asset('adminpage')}}/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    ...
    <!-- iCheck -->
    <script src="{{asset('adminpage')}}/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
