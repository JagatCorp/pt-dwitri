            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <a href="hapuspegawai/{{ $items->id }}"><button type="button" class="btn btn-danger  btn-md" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"><i class="glyphicon glyphicon-remove-circle"></i></button></a></td>
                      </tr>
                    @endforeach
                    </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <select name="jk" multiple class="form-control" id="exampleFormControlSelect1">
  ...
  <div class="form-group">
    ...
    <input type="number" name="no_telp" class="form-control" id="exampleFormControlInput1"  required>
  </div>
...
<div class="modal fade" id="editPegawai{{ $items->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
        <label for="exampleFormControlInput1">No Telp</label>
        <input type="number" name="no_telp" value="{{ $items->no_telp }}" class="form-control" id="exampleFormControlInput1"  required>
      </div>
