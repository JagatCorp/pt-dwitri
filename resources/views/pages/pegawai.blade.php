...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="text" name="no_telp" class="form-control" id="exampleFormControlInput1"  required>
  </div>
...
<div class="modal fade" id="editPegawai{{ $items->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
        <label for="exampleFormControlInput1">No Telp</label>
        <input type="text" name="no_telp" value="{{ $items->no_telp }}" class="form-control" id="exampleFormControlInput1"  required>
      </div>
